...
Yay! The extension "{{ .extension }}" is valid :tada:.

Now, @docker/extensions will add the `review/succeeded` label to the issue which will start the publishing of the extension on the marketplace.
